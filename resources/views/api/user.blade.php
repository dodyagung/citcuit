...
<section class="tweet tweet-odd">
    ...
    <div class="split-left">
        <a href="{{ $profile->profile_image_url_https_full }}" target="_blank"><img src="{{ $profile->profile_image_url_https }}" class="img-avatar"></a>
    </div>
    <div class="split-right">
        ...
        <small><img class="img-action" src="{{ url('assets/img/location.png') }}" alt="Location" />&nbsp;&nbsp;{{ $profile->location }}</small><br />
        <small><img class="img-action" src="{{ url('assets/img/url.png') }}" alt="Url" />&nbsp;{!! $profile->url !!}</small><br />
    </div>
    <br />
...
@endforeach
<section>
    <a class="pagination pagination-right" href="{{ url('/user/' . $screen_name . '/older/' . $timeline->max_id) }}">
        Older [&rarr;]
    </a>
</section>
