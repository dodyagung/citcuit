...
<section>
    ...
    <a class="pagination left" href="{{ url('followers/' . $screen_name . '/cursor/' . $users->previous_cursor_str) }}">
        [&larr;] Previous 
    </a>
    @endif
    <a class="pagination right" href="{{ url('followers/' . $screen_name . '/cursor/' . $users->next_cursor_str) }}">
        Next [&rarr;] 
    </a>
</section>
